# [Travels Management System](https://soft-ui-dashboard-laravel.creative-tim.com/login)
...
*Frontend version*: Travels Management System v1.0.0. More info at https://www.creative-tim.com/product/soft-ui-dashboard
...
Travels Management System comes with dozens of handcrafted UI elements tailored for Bootstrap 5 and an out of the box Laravel backend.

## What am I getting?
You're getting a multi-purpose tool for building complex apps.

Travels Management System PRO Laravel at a glance:
...
Whether you're working on a side project or delivering to a client, we've got you covered. Travels Management System is released under MIT license, so you can use it both for personal and commercial projects for free. All you need to do is start coding. 


## Detailed documentation and example pages
We also included detailed documentation for every component and feature so you can follow along. The pre-built example pages give you a quick glimpse of what Travels Management System has to offer so you can get started in no time. 

If you want to get more features, go PRO with [Travels Management System PRO Laravel](https://www.creative-tim.com/product/soft-ui-dashboard-pro-laravel).
...
## Documentation
The documentation for the Travels Management System is hosted at our [website](https://soft-ui-dashboard-laravel.creative-tim.com/documentation/getting-started/overview.html).
...
## Reporting Issues
We use GitHub Issues as the official bug tracker for the Travels Management System. Here are some advices for our users that want to report an issue:

1. Make sure that you are using the latest version of the Travels Management System. Check the CHANGELOG from your dashboard on our [website](https://www.creative-tim.com/product/soft-ui-dashboard-pro-laravel?ref=readme-sudpl).
